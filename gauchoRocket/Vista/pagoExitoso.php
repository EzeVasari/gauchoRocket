<?php
    ...
    $queryTrayecto = "SELECT t.precio, t.nombreTrayecto as nombreTrayecto, t.fkCodigoLugarOrigen as origen, t.fkCodigoLugarDestino as destino 
                  FROM reserva AS r 
    ...
    $precioViaje =  $trayecto["precio"] * $asientos["personas"];
    ...
    echo '<div class="col-0-md-7 text-center mt-5">
                  ...
                  <ul class="list-group mb-2">
                    ...
                    <li class="list-group-item d-flex justify-content-between lh-condensed">
                      <div>
                        ...
                        <small class="text-muted">Monto final del servicio '.$servicio["nombreServicio"].'</small>
                      </div>
