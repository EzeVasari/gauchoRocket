    ...
    <div class='container buscador p-3 mb-3 border border-info'>
            ...
            <div class="row justify-content-center">
                <div class="col-md-7 text-center mb-3">
                    ...
                    <p class="text-muted">
                        puede volver a eliminar un viaje accediendo en  eliminar otro o volver al inicio
                    </p>
                    <a href='adminMantenimiento.php' class='btn btn-primary'> eliminar otro viaje</a>
